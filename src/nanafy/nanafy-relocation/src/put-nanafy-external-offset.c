...
int put_nanafy_external_offset (size_t symid, nanafy_section section, size_t size, nanafy *nana){
	switch (put_nanafy_external_offset_manually(symid, section, size, nana)){
		case NANAFY_SUCCESS:
			return 0;
		case NANAFY_TEXT_MEMORY_NOT_ENOUGH_MEMORY:
			...
			return put_nanafy_external_offset(symid, section, size, nana);
