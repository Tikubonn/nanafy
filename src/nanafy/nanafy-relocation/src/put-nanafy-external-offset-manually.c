...
nanafy_status put_nanafy_external_offset_manually (size_t symid, nanafy_section section, size_t size, nanafy *nana){
	...
	if (add_nanafy_section_relocation(symid, section, offset, size, nana) != 0){
		return NANAFY_ERROR;
	}
