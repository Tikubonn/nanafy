...
nanafy_status register_nanafy_private_symbol_manually (char *symname, size_t symnamesize, nanafy_section section, nanafy *nana, size_t *symidp){
	...
	init_nanafy_private_symbol(section, offset, symnameoffset, &symbol);
