...
int register_nanafy_private_symbol (char *symname, size_t symnamesize, nanafy_section section, nanafy *nana, size_t *symidp){
	switch (register_nanafy_private_symbol_manually(symname, symnamesize, section, nana, symidp)){
		case NANAFY_SUCCESS:
			return 0;
		case NANAFY_SYMNAME_TABLE_ARRAY_NOT_ENOUGH_MEMORY:
			...
			return register_nanafy_private_symbol(symname, symnamesize, section, nana, symidp);
