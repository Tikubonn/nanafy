...
nanafy_status add_nanafy_section_relocation (size_t symid, nanafy_section section, size_t offset, size_t size, nanafy *nana){
	switch (section){
		case NANAFY_TEXT_SECTION: {
			nanafy_relocation relocation;
			init_nanafy_relocation(symid, offset, size, &relocation);
			size_t index;
